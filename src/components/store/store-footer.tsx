        ...
        <div className="grid gap-12 lg:grid-cols-4">
          ...
          <motion.div {...fadeInUp} className="space-y-6">
            <div className="flex items-center gap-3">
              <div className="relative h-10 w-10 rounded-lg overflow-hidden bg-white/10 border border-white/20 shadow-lg">
                <Image
              ...
              <div>
                <h3 className="text-lg font-bold text-white">JKSPORTSHUB</h3>
                <p className="text-xs text-white/60 uppercase tracking-wider">Premium Sports Equipment</p>
              </div>
            </div>
            
            <p className="text-sm leading-relaxed text-white/70 max-w-xs">
              Your trusted destination for professional-grade sports equipment. Quality gear with expert guidance since 2010.
            </p>
            ...
            <div className="flex gap-3">
              <a 
                href="#" 
                className="w-10 h-10 rounded-full border border-white/30 bg-black flex items-center justify-center text-white hover:bg-white hover:text-black transition-all duration-300"
          ...
          <motion.div {...fadeInUp} transition={{ duration: 0.5, delay: 0.1 }} className="space-y-6">
          ...
          <motion.div {...fadeInUp} transition={{ duration: 0.5, delay: 0.2 }} className="space-y-6">
          ...
          {/* Column 4: Categories */}
          <motion.div {...fadeInUp} transition={{ duration: 0.5, delay: 0.3 }} className="space-y-6">
        ...
        <div className="mx-auto max-w-7xl px-6 py-4 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-white/50">
              © {currentYear} JKSPORTSHUB. All rights reserved.
            </p>
